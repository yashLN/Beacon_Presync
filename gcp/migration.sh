...
wget https://raw.githubusercontent.com/yashLN/Beacon_Presync/main/gcp/docker-compose.yaml
wget https://raw.githubusercontent.com/yashLN/Beacon_Presync/main/gcp/beacon-geth.service

log "Downloaded!!"
log "Stopping the current beacon-geth service"
sudo systemctl stop beacon-geth.service
[ -e /var/docker-compose.yaml ] && sudo rm /var/docker-compose.yaml
log "Stopped beacon-geth Service"

log "Apply the new beacon-geth Service"

sudo cp docker-compose.yaml /var/docker-compose.yaml
...
docker pull public.ecr.aws/n2u0q7l0/geth:stable
